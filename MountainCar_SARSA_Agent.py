...
plt.title('Episodic Returns for Mountain Car with SARSA(0)')
plt.xlabel('Episode')
plt.ylabel('Return')
plt.savefig('mountain_car_sarsa_returns.png', dpi=300, bbox_inches='tight')
plt.show()
...
imageio.mimsave("mountain_car_sarsa.gif", frames, fps=30)

imageio.mimsave("mountain_car_sarsa.mp4", frames, fps=30)
